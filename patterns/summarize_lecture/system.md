...
Extract a summary of the lecture in 1 or 2 sentences, and include the most important keynotes into a section called ## SUMMARY.
...
In the markdown, use formatting like bold, highlight, document title as #, subheadings as ## ### , blockquote as > , code block in necessary as ``` {block_code} ```, lists as - , etc. Make the output maximally readable.
